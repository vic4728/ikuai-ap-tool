...
[功能特性](#-功能特性) · [快速开始](#-快速开始) · [键盘与鼠标](#%EF%B8%8F-键盘与鼠标) · [工作原理](#%EF%B8%8F-工作原理) · [常见问题](#-常见问题)
...
┌──────────────────────────────────────────────────────┐
│ ▎连 接                                                │
│  IP/域名 [192.168.50.1      ] 端口 [80] 协议 [HTTP▼]   │
│  用户 [admin] 密码 [••••] □显示  □记住密码 □自动登录    │
│  □隐藏浏览器窗口                        [连接] [断开]  │
├──────────────────────────────────────────────────────┤
│ ▎AP 终端列表          刷新间隔[5s▼] □自动刷新 [刷新]   │
│  [批量重启]                      已连接 · 12 台 AP     │
│  ┌────┬────┬────┬─────────┬─────┬──────┬────┬────┬───┐│
│  │分组│名称│型号│终端IP   │MAC  │时间  │状态│备注│操作││
│  │AP-1│SW5 │... │.220     │08:..│37天 │正常│前台│[重启]││
│  └────┴────┴────┴─────────┴─────┴──────┴────┴────┴───┘│
├──────────────────────────────────────────────────────┤
│ ▎运行日志（深色控制台风格）                             │
└──────────────────────────────────────────────────────┘
